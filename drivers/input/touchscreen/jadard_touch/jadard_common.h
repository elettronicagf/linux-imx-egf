...
#define JADARD_DRIVER_VER		 "01.FD" /* MAJOR_VER.MINOR_VER */
#define JADARD_DRIVER_CID_VER	 "B0.00" /* MAJOR_CID_VER.MINOR_CID_VER */
...
#define JD_USB_DETECT_DELAY_TIME (15000)
...
extern int jadard_jd9365tl_probe(void);
extern int jadard_jd9365tl_remove(void);
...
#ifdef CONFIG_JD_HID
extern int jadard_spi_hid_init(void);
extern void jadard_spi_hid_exit(void);
void jadard_spi_hid_work(struct jadard_ts_data *ts);
#endif
